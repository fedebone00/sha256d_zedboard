...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SHA256D_INST_N"

}

proc update_PARAM_VALUE.SHA256D_INST_N { PARAM_VALUE.SHA256D_INST_N } {
	# Procedure called to update SHA256D_INST_N when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SHA256D_INST_N { PARAM_VALUE.SHA256D_INST_N } {
	# Procedure called to validate SHA256D_INST_N
	return true
}
...
proc update_MODELPARAM_VALUE.SHA256D_INST_N { MODELPARAM_VALUE.SHA256D_INST_N PARAM_VALUE.SHA256D_INST_N } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SHA256D_INST_N}] ${MODELPARAM_VALUE.SHA256D_INST_N}
}
