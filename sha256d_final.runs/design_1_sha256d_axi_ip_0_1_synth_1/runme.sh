...
HD_PWD='D:/Uni/RL/sha256d_zedboard/sha256d_final.runs/design_1_sha256d_axi_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sha256d_axi_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sha256d_axi_ip_0_1.tcl
