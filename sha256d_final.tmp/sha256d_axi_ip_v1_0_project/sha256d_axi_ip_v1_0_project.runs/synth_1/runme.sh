...
HD_PWD='d:/uni/rl/sha256d_zedboard/sha256d_final.tmp/sha256d_axi_ip_v1_0_project/sha256d_axi_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256d_axi_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha256d_axi_ip_v1_0.tcl
